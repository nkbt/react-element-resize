...
function (_React$Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onLog", function (data) {
      _this.setState(function (_ref) {
        var log = _ref.log;
        return {
          log: [JSON.stringify(data)].concat(log).slice(0, 20)
        };
      });
    });
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "app"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "react-element-resize"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Debounce scrolling and resize by 200ms"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_src_Component__WEBPACK_IMPORTED_MODULE_1__["ReactElementResize"], {
        className: "wrapper",
        debounceTimeout: 200,
        onResize: this.onLog,
        onScroll: this.onLog
      ...
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Debounce scrolling by 200ms but no more then 1000ms"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_src_Component__WEBPACK_IMPORTED_MODULE_1__["ReactElementResize"], {
        className: "wrapper",
        debounceTimeout: 200,
        debounceOptions: {
          maxWait: 1000
...
/*!**************************!*\
  !*** ./src/Component.js ***!
  \**************************/
/*! exports provided: ReactElementResize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function (_React$Component) {
  ...
  function ReactElementResize(props) {
    ...
    if (_onResize) {
      _this.onResizeDebounced = debounceTimeout > -1 ? lodash_debounce__WEBPACK_IMPORTED_MODULE_2___default()(_this.onResize, debounceTimeout, debounceOptions) : _this.onResize;
    }

    if (_onScroll) {
      _this.onScrollDebounced = debounceTimeout > -1 ? lodash_debounce__WEBPACK_IMPORTED_MODULE_2___default()(_this.onScroll, debounceTimeout, debounceOptions) : _this.onScroll;
    }
...
_defineProperty(ReactElementResize, "propTypes", {
  ...
  debounceOptions: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.shape({
    leading: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool,
    trailing: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool,
    maxWait: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number
  }),
